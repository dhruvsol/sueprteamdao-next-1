		...
		>
			...
			>
				...
				<Typography
					...
					sx={{ py: 3 }}
				>
					We help the most promising projects in the Solana ecosystem
					in the ascending world (India, South East Asia, Eastern
					Europe, and Africa) launch and grow.
				</Typography>
				<Box
					sx={{
						alignItems: {
				...
				>
					...
					{['Lurkers', 'Contributors', 'Founders', 'Developers'].map(
						(item) => (
							<Box
								key={item}
								sx={{
